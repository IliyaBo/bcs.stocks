...
public class Symbol implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!sector.equals(symbol1.sector)) {
      return false;
    }
    if (!securityType.equals(symbol1.securityType)) {
      return false;
    }
    if (!bidPrice.equals(symbol1.bidPrice)) {
      return false;
    }
    if (!bidSize.equals(symbol1.bidSize)) {
      return false;
    }
    if (!askPrice.equals(symbol1.askPrice)) {
      return false;
    }
    if (!askSize.equals(symbol1.askSize)) {
      return false;
    }
    if (!lastUpdated.equals(symbol1.lastUpdated)) {
      return false;
    }
    if (!lastSalePrice.equals(symbol1.lastSalePrice)) {
      return false;
    }
    if (!lastSaleSize.equals(symbol1.lastSaleSize)) {
      return false;
    }
    if (!lastSaleTime.equals(symbol1.lastSaleTime)) {
      return false;
    }
    if (!volume.equals(symbol1.volume)) {
      return false;
    }
